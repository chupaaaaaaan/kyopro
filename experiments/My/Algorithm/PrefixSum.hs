module My.Algorithm.PrefixSum where
...
rectangleSum :: (Ix a, Ix b, Enum a, Enum b, Num c) => ((a, b) -> c) -> (a, b) -> (a, b) -> c
rectangleSum f (a,b) (c,d) = f (c,d) + f (pred a,pred b) - f (pred a,d) - f (c,pred b)
